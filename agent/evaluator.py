...
def evaluate_merged_file(
    ...
    if details_json is not None:
        ...
        ensure_parent_dir(details_json)
...
if __name__ == "__main__":
    ...
    eval_json = project_root / "reports" / "evals" / "risk_labeler_v1_eval.json"
    details_json = project_root / "reports" / "evals" / "risk_labeler_v1_eval_details.json"
