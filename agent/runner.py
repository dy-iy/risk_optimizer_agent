...
if __name__ == "__main__":
    ...
    script_path = project_root / "scripts" / "risk_labeler_v1.py"
    input_csv = project_root / "data" / "input" / "raw_1000_news.csv"
    output_csv = project_root / "reports" / "predictions" / "risk_labeler_v1_output.csv"
    log_json = project_root / "reports" / "predictions" / "risk_labeler_v1_runlog.json"
