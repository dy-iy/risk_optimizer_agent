...
VOL_PREDICTION_WORDS = ["预测", "可能", "若", "如果", "预期", "分析", "报道", "历史"]
...
KW_LIQ_EARLY = ["期权到期", "资金费率", "清算强度", "强平价格", "爆仓额", "清算金额"]
...
NEG_WHALE_DISCUSSION = ["预测", "可能", "若", "如果", "分析", "评论", "报道", "历史"]
